    ...
    <div className="flex min-h-screen items-center justify-center bg-[#FAFBFF] px-6 py-12 text-slate-900">
      <div className="w-full max-w-lg rounded-[2rem] border border-slate-100 bg-white p-8 shadow-2xl shadow-slate-200/60">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-black uppercase italic tracking-tight text-slate-950">Reset Password</h1>
          <p className="mt-2 text-sm font-semibold text-slate-500">Create a new password for your account</p>
        </div>
